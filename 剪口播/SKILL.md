...
<!--
input: 视频文件 (*.mp4)
output: subtitles_words.json、auto_selected.json、review.html、剪后视频、video.srt/subtitles.srt
pos: 口播素材准备入口；默认完成粗剪 + 剪后字幕
